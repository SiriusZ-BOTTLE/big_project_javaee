...
public class GroupxEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (groupDescription != null ? !groupDescription.equals(that.groupDescription) : that.groupDescription != null)
            return false;
        if (groupCoverUrl != null ? !groupCoverUrl.equals(that.groupCoverUrl) : that.groupCoverUrl != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (groupCoverUrl != null ? groupCoverUrl.hashCode() : 0);
